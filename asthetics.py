...
parameter_labels = {'T': r'$T$ (K)', 'log_xh2o': r'log $X_{\rm H_2O}$', 'log_xnh3': r'log $X_{\rm NH_3}$', 'log_xch4': r'log $X_{\rm CH_4}$',
                    'log_xco2': r'log $X_{\rm CO_2}$', 'log_xco': r'log $X_{\rm CO}$', 'log_xso2': r'log $X_{\rm SO_2}$',
...
parameter_colors = {'T': ['Reds', 0.4], 'log_xh2o': ['Blues', 0.4], 'log_xnh3': ['YlGn', 0.3], 'log_xch4': ['RdPu', 0.3],
                    'log_xco2': ['Oranges', 0.3], 'log_xco': ['GnBu', 0.3], 'log_xso2': ['YlGn', 0.3],
