...
def load_opacity(temperature, pressure, molecule):
    ...
    wavenumber_min = int(1e4/wavelength_centre[-1])
    wavenumber_max = int(1e4/wavelength_centre[0])
...
def tau(p0_bar):
    ...
    for molecule in molecules:
        ...
        for i, t in enumerate(temp_dict[molecule]):
        ...
        integral_dict[molecule] = interp1d(temp_dict[molecule], integral_grid_molecule, axis=0,
                                           bounds_error=False,
